                ...
                <div className="full-about">
                    <div className="container">
                        <div className="page-content">
                            ...
                            <p>General Manager and Chef de Cuisine JP Parvis has extensive experience in the Culinary industry, as the Manager of Zingerman’s Deli’s Next Door Cafe, Chef de cuisine at Ulterior/ Lionfish, Sous Chef at Red and 515. JP has been a member of the Tannery community since it first opened, and worked as the chef for the Art Bar Cafe that preceded the Dead Cow in the same location. His deep ties in Santa Cruz and extensive experience make him the most qualified person for the position in matters of both Front and Back of house operations.</p>
