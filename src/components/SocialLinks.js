        ...
        if (this.props.text) {
            return (
                <div className="social">
                    <ul>
                        <li>
                            <a href="https://www.facebook.com/deadcowsc" target="_blank">Facebook</a>
                        </li>
                        <li>
                            <a href="https://twitter.com/deadcowsc" target="_blank">Twitter</a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/deadcowsc" target="_blank">Instagram</a>
                        </li>
                        <li>
